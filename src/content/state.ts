...
export const QUICK_ACTIONS: readonly QuickAction[] = [
  ...
  { label: "Проверь форму", prompt: "Проверь заполнение форм на странице: что не заполнено, что выглядит некорректно." },
  { label: "Сделай чек-лист", prompt: "Сформируй чек-лист действий по содержимому этой страницы." },
  { label: "Сформулируй ответ", prompt: "Сформулируй вежливый деловой ответ по содержимому этой страницы." },
];
