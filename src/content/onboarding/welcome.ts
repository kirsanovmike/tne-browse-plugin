...
const SLIDES: Slide[] = [
  { icon: "doc", title: "Я читаю открытую страницу",
    body: "Беру содержимое текущей вкладки и отвечаю строго по нему.\nСпросите о чём угодно на этой странице." },
  { icon: "grid", title: "Не только вопросы",
  ...
  { icon: "compass", title: "Покажу, где что лежит",
    body: "За минуту проведу по основным кнопкам.\nЗапустить заново можно кнопкой «?» в шапке." },
];
